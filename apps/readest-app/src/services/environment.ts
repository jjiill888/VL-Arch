...
import { VLARCH_NODE_BASE_URL, VLARCH_WEB_BASE_URL } from './constants';
...
export const getBaseUrl = () => process.env['NEXT_PUBLIC_API_BASE_URL'] ?? VLARCH_WEB_BASE_URL;
export const getNodeBaseUrl = () =>
  process.env['NEXT_PUBLIC_NODE_BASE_URL'] ?? VLARCH_NODE_BASE_URL;
